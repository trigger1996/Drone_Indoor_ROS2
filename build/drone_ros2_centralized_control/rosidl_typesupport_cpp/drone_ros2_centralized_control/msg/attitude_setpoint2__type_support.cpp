...
static const _AttitudeSetpoint2_type_support_symbol_names_t _AttitudeSetpoint2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_ros2_centralized_control, msg, AttitudeSetpoint2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drone_ros2_centralized_control, msg, AttitudeSetpoint2)),
  }
};
...
{
  return &::drone_ros2_centralized_control::msg::rosidl_typesupport_cpp::AttitudeSetpoint2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, drone_ros2_centralized_control, msg, AttitudeSetpoint2)() {
  return get_message_type_support_handle<drone_ros2_centralized_control::msg::AttitudeSetpoint2>();
}
