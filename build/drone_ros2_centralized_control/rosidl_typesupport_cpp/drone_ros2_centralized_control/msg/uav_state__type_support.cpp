...
static const _UavState_type_support_symbol_names_t _UavState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_ros2_centralized_control, msg, UavState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drone_ros2_centralized_control, msg, UavState)),
  }
};
...
{
  return &::drone_ros2_centralized_control::msg::rosidl_typesupport_cpp::UavState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, drone_ros2_centralized_control, msg, UavState)() {
  return get_message_type_support_handle<drone_ros2_centralized_control::msg::UavState>();
}
