...
static const _UavState_type_support_symbol_names_t _UavState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_ros2_centralized_control, msg, UavState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, drone_ros2_centralized_control, msg, UavState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, drone_ros2_centralized_control, msg, UavState)() {
  return &::drone_ros2_centralized_control::msg::rosidl_typesupport_c::UavState_message_type_support_handle;
}
