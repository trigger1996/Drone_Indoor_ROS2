    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'drone_ros2_centralized_control.msg.UavCmd')
            logger.debug(
...
class UavCmd(metaclass=Metaclass_UavCmd):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_arm = kwargs.get('is_arm', int())
    ...
    def is_arm(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'is_arm' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'is_arm' field must be an integer in [-2147483648, 2147483647]"
        self._is_arm = value
