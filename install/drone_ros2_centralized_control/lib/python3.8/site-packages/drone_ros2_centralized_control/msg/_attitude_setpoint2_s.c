...
bool drone_ros2_centralized_control__msg__attitude_setpoint2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drone_ros2_centralized_control.msg._attitude_setpoint2.AttitudeSetpoint2", full_classname_dest, 72) == 0);
  }
  drone_ros2_centralized_control__msg__AttitudeSetpoint2 * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of AttitudeSetpoint2 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("drone_ros2_centralized_control.msg._attitude_setpoint2");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AttitudeSetpoint2");
